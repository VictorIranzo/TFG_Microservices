...
Se desea desarrollar un sistema para la venta de productos a través de dispositivos móviles. La aplicación móvil estará destinada solo a los clientes de una tienda, que deberán registrarse para usarla.
...
Una vez un cliente haya confirmado un pedido, este deberá ser aprobado por un empleado para ser entregado. Mientras que el empleado no lo apruebe, el pedido podrá ser cancelado garantizando su reembolso completo. Además, cuando el pedido sea entregado físicamente al cliente, este deberá marcar el pedido como entregado.

En cualquier momento, un cliente puede crear una incidencia si tiene algún problema con un pedido o quiere consultar una duda con el equipo que gestiona la aplicación. Dentro de una incidencia, tanto el cliente como los empleados se comunicarán a través de mensajes. Cuando lo considere oportuno, el cliente podrá cerrar la incidencia creada, que podrá volver a consultar en cualquier momento.

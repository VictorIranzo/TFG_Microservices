...
El capítulo 3 presenta brevemente el estado del arte asociado a la tecnología de los microservicios, explicando brevemente algunas de las herramientas más empleadas. También se incluye una crítica al estado del arte, compuesta en parte por la revisión de algunos trabajos realizados en la universidad.
...
\item Diseñar microservicios con el menor \textbf{tamaño} posible no debe ser el foco principal. El código relacionado debe agruparse conjuntamente porque será modificado por el mismo motivo. En todo momento han de cumplirse los principios de alta cohesión y bajo acoplamiento. La cohesión es la medida en la que un componente tiene una única responsabilidad. El acoplamiento es la medida en la que el cambio de un componente requiere el cambio de otros \cite{Newman2015a}.

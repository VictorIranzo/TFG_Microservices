...
\subsection{Consumo de otros microservicios}

Para que un microservicio pueda hacer peticiones a otro se deben seguir los siguientes pasos:

\begin{enumerate}

\item Instalar el paquete NuGet del microservicio a instalar en la capa de aplicación.

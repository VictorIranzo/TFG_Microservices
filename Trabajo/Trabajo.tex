...
Un \textbf{proveedor de servicios en la nube} \footnote{ What is a cloud service provider?
...
Para terminar, para las pruebas a nivel de API se ha hecho uso de Postman. Postman es un entorno para el desarrollo de APIs (ADE) que nos va a permitir crear y almacenar de forma sencilla llamadas HTTP hacia la API del \textit{back-end}. \footnote{ Página oficial de Postman: https://www.getpostman.com/}
...
En la figura \ref{fig:AndroidFileManager} se presenta la implementación específica hecha en la plataforma Android para la interfaz \textit{IFileManager}, que ofrece diversas operaciones relacionadas con el sistema de archivos.

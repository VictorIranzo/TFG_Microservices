...
Kubernetes se emplea principalmente para especificar el número de réplicas que se desea tener simultáneamente de un pod. La herramienta nos permite fácilmente asegurar la disponibilidad de un servicio. No obstante, para garantizar la escalabilidad de esta se requiere de mayores conocimientos. Esto se consigue haciendo que el número de réplicas de un pod se modifique de forma dinámica en función de su demanda. Para este propósito se deben introducir balanceadores de carga como puntos de entrada al sistema. Estos balanceadores redirigirán cada petición al pod correspondiente y se encargarán de ajustar el número de réplicas de un pod según una serie de reglas.
